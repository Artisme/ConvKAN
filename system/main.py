...
def run(args):
    ...
    for i in range(args.prev, args.times):
        ...
        elif model_str == "ConvKAN":
            args.model = DeepConvKAN(num_classes=args.num_classes).to(args.device)

        elif model_str == "FedLightCNN":
            args.model = FedLightCNN(num_classes=args.num_classes).to(args.device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-opt', "--optimizer", type=str, default="sgd", choices=["sgd", "adam"], help="Optimizer to use (sgd or adam)")
